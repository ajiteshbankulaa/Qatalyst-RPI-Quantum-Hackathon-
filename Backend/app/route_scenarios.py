...
from app.schema_scenario import ScenarioCreate, ScenarioResponse, ScenarioUpdate
from app.service_scenarios import create_scenario, delete_scenario, get_scenario_or_404, list_scenarios, update_scenario
